...
public abstract class ForwardingBase
    ...
    public boolean pushRoute(Route route, OFMatch match,
        ...
        for (int indx = switchPortList.size()-1; indx > 0; indx -= 2) {
            ...
            fm.getMatch().setInputPort(OFSwitchPort.physicalPortIdOf(inPort));
            ((OFActionOutput)fm.getActions().get(0)).setPort(OFSwitchPort.physicalPortIdOf(outPort));
            ...
            try {
                ...
                if (sw.getId() == pinSwitch) {
                    ...
                    pushPacket(sw, pi, false, OFSwitchPort.physicalPortIdOf(outPort), cntx);
