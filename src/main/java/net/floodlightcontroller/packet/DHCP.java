...
public class DHCP extends BasePacket {
    ...
    public String toString() {
    	/* A new string buffer. */
    	StringBuffer sb = new StringBuffer("[dhcp: ");

        sb.append(" packet_type: ");
        sb.append(this.getPacketType().toString());
        if (this.getBootFileName() != null)
        	sb.append(", bootFileName=" + this.getBootFileName());
        if (this.getClientHardwareAddress() != null)
        	sb.append(", clientHWAddres=" + HexString.toHexString(this.getClientHardwareAddress()));
        if (this.getClientIPAddress() != 0)
        	sb.append(", clientIPAddress=" + IPv4.fromIPv4Address(this.getClientIPAddress()));
        if (this.getServerIPAddress() != 0)
        	sb.append(", serverIPAddress=" + IPv4.fromIPv4Address(this.getServerIPAddress()));
        if (this.getServerName() != null)
        	sb.append(", serverName=" + this.getServerName());
        if (this.getGatewayIPAddress() != 0)
        	sb.append(", gateway=" + IPv4.fromIPv4Address(this.getGatewayIPAddress()));
        if (this.getYourIPAddress() != 0)
        	sb.append(", ipAddres=" + IPv4.fromIPv4Address(this.getYourIPAddress()));
        if (this.getBootFileName() != null)
        	sb.append(", bootFile=" + this.getBootFileName());
        if (this.getOptions() != null && !this.getOptions().isEmpty()) {
        	sb.append(", options=");
        	for (DHCPOption option : this.getOptions()) {
