...
public class IPv4 extends BasePacket {
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("[ipv4: ");

        sb.append(" nw_src: ");
        sb.append(IPv4.fromIPv4Address(this.sourceAddress));
        sb.append(", nw_dst: ");
        sb.append(IPv4.fromIPv4Address(this.destinationAddress));
        sb.append(", nw_tos: ");
        sb.append(this.getDiffServ());
        
        if (!protocolClassMap.containsKey(this.getProtocol())) {
        	sb.append(", unknown payload");
        } else {
        	IPacket pkt = (IPacket) this.getPayload();
        	sb.append(pkt.toString());
        }
