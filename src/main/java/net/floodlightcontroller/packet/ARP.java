...
public class ARP extends BasePacket {
    ...
    public String toString() {
    	/* A new string buffer. */
    	StringBuffer sb = new StringBuffer("[arp: ");

        sb.append(" hardwareType=" + hardwareType);
        sb.append(", protocolType=" + protocolType);
        sb.append(", hardwareAddressLength=" + hardwareAddressLength);
        sb.append(", protocolAddressLength=" + protocolAddressLength);
        sb.append(", opCode=" + opCode);
        sb.append(", senderHardwareAddress=" + HexString.toHexString(senderHardwareAddress));
        sb.append(", senderProtocolAddress=" + IPv4.fromIPv4Address(IPv4.toIPv4Address(senderProtocolAddress)));
        sb.append(", targetHardwareAddress=" + HexString.toHexString(targetHardwareAddress));
        sb.append(", targetProtocolAddress=" + IPv4.fromIPv4Address(IPv4.toIPv4Address(targetProtocolAddress)));
