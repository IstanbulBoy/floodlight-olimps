...
public class Wildcards {
    ...
    final public static int INT_ALL = 0x3FFFFF;
    /** This wildcards all fields except VLAN and Dest MAC address. */
    final public static int INT_MATCH_VLAN_DLSADR = 0x3FFFA0;
    /** Input-port, src and dst macs are NOT wild-carded. */
    public final static int INT_MATCH_INPORT_L2 = 0x3820E0;
    /** Input-port, vlan, src and dest macs are NOT wild-carded. */
    final public static int INT_MATCH_INP_VLAN_DLADRS = 0x3FFFF0;
    /** Input-port, vlan, src and dest macs, new protocol are NOT wild-carded. */
    final public static int INT_MATCH_INP_VLAN_DLADRS_ET = 0x3FFFE0;
    /** Input-port, vlan, src and dest macs etype, proto, dstprt are NOT wild-carded. */
    final public static int INT_MATCH_INP_VLAN_DLADRS_ET_PROTO_DP = 0x3FFF40;
    /** Input-port, vlan, src and dest macs etype, proto are NOT wild-carded. */
    final public static int INT_MATCH_INP_VLAN_DLADRS_ET_PROTO = 0x3FFFC0;
    /** Input-port, vlan, src and dest macs, ether-type and L3 addresses are NOT wild-carded. */
    final public static int INT_MATCH_INP_VLAN_DLADRS_ETYP_NWADRS = 0x3000E0;
    /** */
    final public static int INT_PCP_TOS_L4PSPRT       = 0x300060;
    /** */
    final public static int INT_PCP_TOS_L4PDPRT       = 0x3000A0;
    /** */
    final public static int INT_PCP_L3SADR_TOS_L4SPRT = 0x303F60;
    /** */
    final public static int INT_PCP_L3DADR_TOS_L4DPRT = 0x3FC0A0;
    /** */
    final public static int INT_PCP_L3PROT_TOS        = 0x300020;
    /** */
    final public static int INT_NONE                  = 0x0;
    
    /** */
    public final static Wildcards ALL = new Wildcards(OFMatch.OFPFW_ALL_SANITIZED);
    /** */
    public final static Wildcards EXACT = new Wildcards(INT_NONE);
    /** */
    public final static Wildcards INPORT_L2_MATCH = new Wildcards(INT_MATCH_INPORT_L2);
    ...
    public static enum Flag {
    	/* Switch input port. */
        IN_PORT(OFMatch.OFPFW_IN_PORT),
        /* VLAN id. */
        DL_VLAN(OFMatch.OFPFW_DL_VLAN),
        /* Ethernet source address. */
        DL_SRC(OFMatch.OFPFW_DL_SRC),
        /* Ethernet destination address. */
        DL_DST(OFMatch.OFPFW_DL_DST),
        /* Ethernet frame type. */
        DL_TYPE(OFMatch.OFPFW_DL_TYPE),
        /* IP protocol. */
        NW_PROTO(OFMatch.OFPFW_NW_PROTO),
        /* TCP/UDP source port. */
        TP_SRC(OFMatch.OFPFW_TP_SRC),
        /* TCP/UDP destination port. */
        TP_DST(OFMatch.OFPFW_TP_DST),
        /* VLAN priority. */
        DL_VLAN_PCP(OFMatch.OFPFW_DL_VLAN_PCP),
        /*
    ...
    /** convenience method return a wildcard for exactly one set flag */
    public static Wildcards of(Wildcards.Flag setFlag) {
        return Wildcards.of(setFlag.wildcard(0));
    }

    /** convenience method return a wildcard for exactly two set flags */
    ...
    /** convenience method return a wildcard for an arbitrary number of set flags */
    ...
    /** convenience method return a wildcards for ofmatches that match on one flag */
    public static Wildcards ofMatches(Wildcards.Flag setFlag) {
        return Wildcards.of(setFlag.matchOn(INT_ALL));
    }

    /**
     * convenience method return a wildcard for for an ofmatch that match on two
     * flags
     */
    public static Wildcards ofMatches(Wildcards.Flag setFlag, Wildcards.Flag setFlag2) {
        return Wildcards.of(setFlag.matchOn(setFlag2.matchOn(INT_ALL)));
    }

    /**
     * convenience method return a wildcard for an ofmatch that amtch on an
    ...
    /**
     * True iff this wildcard field currently fully on (fully wildcarded), i.e.
