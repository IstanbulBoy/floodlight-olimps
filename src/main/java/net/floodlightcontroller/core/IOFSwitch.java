...
public interface IOFSwitch {
    ...
    public static class PortChangeEvent {
    	/** */
        public final OFSwitchPort port;
        /** */
         ...
         * @param type
         */
        public PortChangeEvent(OFSwitchPort port, PortChangeType type) {
            this.port = port;
            this.type = type;
        }
     ...
     */
    public void setDebugCounterService(IDebugCounterService debugCounters) throws CounterException;
     ...
     * @throws IOException
     */
    void writeThrottled(List<OFMessage> msglist, FloodlightContext bc) throws IOException;
   ...
   // public OrderedCollection<PortChangeEvent> setPorts(Collection<OFPhysicalPort> ports);
