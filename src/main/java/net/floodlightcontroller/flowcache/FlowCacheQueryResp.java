...
/**
 * Object to return flows in response to a query message to BetterFlowCache.
...
public class FlowCacheQueryResp {
     ...
     */
    public FlowCacheQuery queryObj;
     ...
     */
    public ArrayList<FlowCacheObj> flowCacheObjList;

    /**
     * Instantiates a new flow cache query response.
     *
     * @param query the flow cache query object as given by the caller of
     * flow cache submit query API.
     */
    public FlowCacheQueryResp(FlowCacheQuery query) {
    	flowCacheObjList = new ArrayList<FlowCacheObj>();
        queryObj    = query;
        moreFlag    = false;
        hasSent     = false;
    }
    ...
    public String toString() {
        String s = queryObj.toString() + "; moreFlasg=" + moreFlag + "; hasSent=" + hasSent;
        s += "; FlowCount=" + Integer.toString(flowCacheObjList.size());
        return s;
    }
}
