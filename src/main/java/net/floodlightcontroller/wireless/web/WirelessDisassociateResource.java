...
public class WirelessDisassociateResource extends ServerResource {
	/** The logger. */
	protected static Logger log = LoggerFactory.getLogger(WirelessDisassociateResource.class);
    ...
    public String handlePost(String hoJson) {
		...
		// Associate a client.
		handoverManager.disassociate(entry.apIp, entry.apMac, entry.clientMac);
		
		// Return a JSON status message.
		return ("{\"status\" : \"client disassociated\"}");
	}
