...
import net.floodlightcontroller.core.web.serializers.UIntegerSerializer;
...
public class NodePortTuple implements Comparable<NodePortTuple> {
    ...
    @JsonProperty("port")
    @JsonSerialize(using=UIntegerSerializer.class)
    ...
    public String toString() {
        return "[id=" + HexString.toHexString(nodeId) + ", port=" + OFSwitchPort.physicalPortIdOf(portId) + "(" + OFSwitchPort.vlanIdOf(portId) + ") ]";
    }
