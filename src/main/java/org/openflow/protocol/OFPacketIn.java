...
public class OFPacketIn extends OFMessage {
    ...
    public OFPacketIn clone() throws CloneNotSupportedException {
    	OFPacketIn clone = new OFPacketIn();
    	// From super.
